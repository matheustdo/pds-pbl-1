...
xlabel('$f$(Hz)','interpreter','latex');
ylabel('Magnitude');
title('Espectro $|X_{c}(j2\pi f)|$ Sinal Convertido D/C','interpreter','latex');
...
xlabel('$f$(Hz)','interpreter','latex');
ylabel('Magnitude');
title('Espectro $|X_{c}(j2\pi f)|$ Sinal Convertido Y','interpreter','latex');
